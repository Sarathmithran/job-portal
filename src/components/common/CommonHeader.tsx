          ...
          <div className="w-full max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-[72px]">
            ...
            <nav className="flex items-center justify-between py-4 sm:py-5 lg:py-[20px]">
              ...
              <div className="hidden md:flex items-center gap-4 lg:gap-[20px]">
                <Link 
                  href="/" 
                  className="text-sm sm:text-base lg:text-[16px] font-figtree font-medium leading-4 sm:leading-5 text-[#ffffff99] hover:text-white transition-colors duration-200"
                >
                  Home
                </Link>
                <Link 
                  href="/jobs" 
                  className="text-sm sm:text-base lg:text-[16px] font-figtree font-semibold leading-4 sm:leading-5 text-white"
                >
                  Jobs
                </Link>
                <Link 
